# Transactions API (scheduled for deprecation ⚠️)

The Transactions API allows ORPs to sync transaction data in real time with Ocra. 
...
|transactionDate|DateTime [ISO8601](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString)|yes     | ISO8601 DateTime the transaction occurred in your system                                                                                                                                                                                                                                                                                                                                                                                                                      |no|
|transactionID  |string         |yes     | Your systems transaction ID                                                                                                                                                                                                                                                                                                                                                                                                                                                   |yes|
|locationID     |string         |yes     | The id for the location of the lot or location in your system                                                                                                                                                                                                                                                                                                                                                                                                                 |yes|
|startDate      |DateTime [ISO8601](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString)|yes     | ISO8601 DateTime the transaction starts from                                                                                                                                                                                                                                                                                                                                                                                                                                  |no|
|endDate        |DateTime [ISO8601](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString)|yes     | ISO8601 DateTime the transaction ends                                                                                                                                                                                                                                                                                                                                                                                                                                         |no|
...
|barcode        |string         |no      | value of barcode used with transaction                                                                                                                                                                                                                                                                                                                                                                                                                                        |no|
...
|transactionDate|DateTime [ISO8601](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString)|yes     | ISO8601 DateTime the transaction occurred in your system|
|transactionID  |string         | Your systems transaction ID|
|locationID     |string         | The id for the location of the lot or location in your system|
|startDate      |DateTime [ISO8601](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString)|yes     | ISO8601 DateTime the transaction starts from|
|endDate        |DateTime [ISO8601](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/toISOString)|yes     | ISO8601 DateTime the transaction ends|
...
|barcode        |string         | value of barcode used with transaction|
